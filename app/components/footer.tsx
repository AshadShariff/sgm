        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-3 text-gray-300 hover:text-[#C89356] transition-colors group"
            >
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-start gap-3 text-gray-300 hover:text-[#C89356] transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-[#1a1a1a] border border-[#C89356]/30 flex items-center justify-center flex-shrink-0 group-hover:border-[#C89356] transition-colors">
